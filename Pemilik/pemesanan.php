<?php
// Include file controller untuk logika pemesanan pemilik
...
<body>
    ...
    <div class="container py-4">
        ...
        <!-- Statistics Cards: Menampilkan ringkasan statistik pemesanan -->
        <div class="row mb-4">
            <!-- Total Pesanan -->
            <div class="col-md-2 col-6 mb-3">
                <div class="card stat-card bg-primary text-white">
                    <div class="card-body text-center py-3">
                        <h4 class="mb-1 fw-bold"><?= htmlspecialchars($stats['total'] ?? 0) ?></h4>
            ...
            <div class="col-md-2 col-6 mb-3">
                <div class="card stat-card bg-warning text-dark">
                    <div class="card-body text-center py-3">
                        <h4 class="mb-1 fw-bold"><?= htmlspecialchars($stats['menunggu'] ?? 0) ?></h4>
            ...
            <div class="col-md-2 col-6 mb-3">
                <div class="card stat-card bg-success text-white">
                    <div class="card-body text-center py-3">
                        <h4 class="mb-1 fw-bold"><?= htmlspecialchars($stats['dikonfirmasi'] ?? 0) ?></h4>
            ...
            <div class="col-md-2 col-6 mb-3">
                <div class="card stat-card bg-info text-white">
                    <div class="card-body text-center py-3">
                        <h4 class="mb-1 fw-bold"><?= htmlspecialchars($stats['menunggu_bayar'] ?? 0) ?></h4>
            ...
            <div class="col-md-2 col-6 mb-3">
                <div class="card stat-card bg-secondary text-white">
                    <div class="card-body text-center py-3">
                        <h4 class="mb-1 fw-bold"><?= htmlspecialchars($stats['lunas'] ?? 0) ?></h4>
                        <small>Lunas</small>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-2 col-6 mb-3">
                <div class="card stat-card bg-danger text-white">
                    <div class="card-body text-center py-3">
                        <h4 class="mb-1 fw-bold"><?= htmlspecialchars($stats['ditolak'] ?? 0) ?></h4>
                        <small>Ditolak</small>
                    </div>
                </div>
            </div>
        ...
        <!-- Filter Status: Button untuk filter berdasarkan status pemesanan -->
        <div class="card mb-4">
            <div class="card-body">
        ...
        <?php else: ?>
            ...
            <?php foreach ($pemesanan as $pesan): ?>
                <?php
                // Definisikan kelas badge untuk setiap status pemesanan
                $badge_class = [
                    'menunggu' => 'bg-warning',
                ...
                // Definisikan kelas badge untuk status pembayaran
                $payment_badge_class = [
                    'menunggu' => 'bg-warning',
                    'lunas' => 'bg-success',
                    'gagal' => 'bg-danger'
                ...
                <div class="card card-pemesanan">
                    <div class="card-body">
                        <div class="row">
                                ...
                                <div class="d-flex align-items-start">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <p class="text-muted mb-1 small">
                                            ...
                                            <?= htmlspecialchars($pesan['telepon']) ?>
                                        </p>
                                        <!-- Email pencari -->
                                        <p class="text-muted mb-1 small">
                                        ...
                                        <!-- Badge status pemesanan dan pembayaran -->
                                        <div class="mt-2">
                                            <!-- Status pemesanan -->
                            ...
                            <!-- Kolom kanan: Harga dan tombol aksi -->
                            <div class="col-md-4">
                                <div class="text-end">
                                    <!-- Total harga -->
                                    ...
                                    <div class="d-grid gap-2">
                                        <!-- Jika status menunggu: Tampilkan tombol konfirmasi dan tolak -->
                                        <?php if ($pesan['status'] === 'menunggu'): ?>
                                            <!-- Form konfirmasi pemesanan -->
                                            <form method="POST" class="d-inline">
                                                <input type="hidden" name="pemesanan_id" value="<?= htmlspecialchars($pesan['id']) ?>">
                                        ...
                                        <!-- Jika status dikonfirmasi: Tampilkan aksi verifikasi pembayaran -->
                                        <?php elseif ($pesan['status'] === 'dikonfirmasi'): ?>
                                            <!-- Jika pembayaran menunggu dan ada bukti bayar -->
                                            <?php if ($pesan['status_pembayaran'] === 'menunggu' && $pesan['bukti_bayar']): ?>
                                                <div class="d-flex gap-2">
                                                    <!-- Form terima pembayaran -->
                                                    <form method="POST" class="flex-fill">
                                                        <input type="hidden" name="pemesanan_id" value="<?= htmlspecialchars($pesan['id']) ?>">
                                                        <input type="hidden" name="pembayaran_id" value="<?= htmlspecialchars($pesan['pembayaran_id']) ?>">
                                                    ...
                                                    <!-- Tombol tolak pembayaran (membuka modal) -->
                                            ...
                                            <!-- Jika pembayaran lunas: Tampilkan tombol selesai -->
                                            ...
                                            <!-- Jika menunggu pembayaran: Tampilkan badge -->
                                            <?php else: ?>
                        ...
                        <!-- Baris informasi tambahan: Periode sewa dan tanggal pemesanan -->
                        <div class="row mt-3">
                            <div class="col-md-6">
                                ...
                                <p class="mb-1 fw-semibold">
                                    ...
                                    (<?= htmlspecialchars($pesan['durasi_bulan']) ?> bulan)
                                </p>
                            </div>
                        ...
                        <!-- Alasan penolakan pembayaran (jika ada) -->
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="detail-section">
                                            ...
                                            <p><strong>Durasi:</strong> <?= htmlspecialchars($pesan['durasi_bulan']) ?> bulan</p>
                                ...
                                <div class="detail-section">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <p><strong>Telepon:</strong> <?= htmlspecialchars($pesan['telepon']) ?></p>
                                        </div>
                                        <div class="col-md-6">
                                ...
                                <!-- Section: Fasilitas kos (jika ada) -->
                                ...
                                <!-- Section: Informasi pembayaran (jika ada) -->
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <?php if ($pesan['bukti_bayar']): ?>
                                                    <p><strong>Bukti Bayar:</strong>
                                                        <!-- Link untuk melihat bukti bayar -->
                                                        <a href="../uploads/bukti_bayar/<?= htmlspecialchars($pesan['bukti_bayar']) ?>"
                                ...
                                <!-- Catatan pembatalan pemesanan (jika ada) -->
                                <?php if (!empty($pesan['catatan_pembatalan'])): ?>
                                    <div class="detail-section">
                            ...
                            <div class="modal-footer">
                                ...
                                <!-- Tombol download PDF -->
                                <a href="/pencari/cetak_pemesanan.php?id=<?= htmlspecialchars($pesan['id']) ?>"
                                    class="btn btn-primary" target="_blank">
                                    <i class="fas fa-file-pdf me-1"></i>Download PDF
                                </a>
                                <!-- Tombol konfirmasi dan tolak jika status menunggu -->
                                <?php if ($pesan['status'] === 'menunggu'): ?>
                                    <form method="POST" class="d-inline">
                                        <input type="hidden" name="pemesanan_id" value="<?= htmlspecialchars($pesan['id']) ?>">
                                        <input type="hidden" name="action" value="konfirmasi">
                ...
                <!-- Modal Tolak Pemesanan (hanya tampil jika status menunggu) -->
                <?php if ($pesan['status'] === 'menunggu'): ?>
                    <div class="modal fade" id="tolakModal<?= $pesan['id'] ?>" tabindex="-1">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <!-- Form untuk menolak pemesanan -->
                                <form method="POST">
                                    <div class="modal-header">
                ...
                <!-- Modal Tolak Pembayaran (hanya tampil jika status dikonfirmasi dan menunggu pembayaran) -->
