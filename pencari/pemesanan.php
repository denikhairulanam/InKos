<?php
include '../controler/pencari/pemesanan.php';
?>
...
<head>
    ...
    <title>Riwayat Pemesanan - INKOS</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <link rel="stylesheet" href="../css/pencari/pemesanan.css">
</head>
            ...
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center flex-wrap">
                    <div class="mb-3 mb-md-0">
                        <h2 class="mb-1">
                            <i class="fas fa-history me-2 text-primary"></i>Riwayat Pemesanan
                        </h2>
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-2 col-6 mb-3">
                <div class="card bg-info text-white">
                    <div class="card-body text-center py-3">
                        <h4 class="mb-1 fw-bold"><?= $stats['selesai'] ?? 0 ?></h4>
                        <small>Selesai</small>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-2 col-6 mb-3">
                <div class="card bg-secondary text-white">
                    <div class="card-body text-center py-3">
                        <h4 class="mb-1 fw-bold"><?= $stats['dibatalkan'] ?? 0 ?></h4>
                                ...
                                <div class="d-flex align-items-start">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <p class="text-muted mb-1 small">
                                            ...
                                            Pemilik: <?= htmlspecialchars($pesan['nama_pemilik']) ?>
                                        </p>
                                        <p class="text-muted mb-1 small">
                                            <i class="fas fa-phone me-1"></i>
                                            <?= $pesan['telepon_pemilik'] ?>
                                        </p>
                            ...
                            <div class="col-md-4">
                                <div class="text-end">
                                    ...
                                    <div class="d-grid gap-2">
                                        <?php if ($pesan['status'] === 'dikonfirmasi' && $pesan['status_pembayaran'] === 'menunggu'): ?>
                                            <a href="pembayaran.php?pemesanan_id=<?= $pesan['id'] ?>"
                                                class="btn btn-success btn-sm">
                                                <i class="fas fa-credit-card me-1"></i>Bayar Sekarang
                                            </a>
                                        <?php elseif ($pesan['status'] === 'menunggu'): ?>
                                            <form method="POST" action="batalkan_pemesanan.php" class="d-inline">
                                        ...
                                        <a href="cetak_pemesanan.php?id=<?= $pesan['id'] ?>"
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="detail-section">
                                            ...
                                            <p><strong>Harga Total:</strong> Rp <?= number_format($pesan['total_harga'], 0, ',', '.') ?></p>
                                ...
                                <!-- Info Pemilik -->
                                <div class="detail-section">
                                    <h6 class="fw-bold mb-3"><i class="fas fa-user me-2"></i>Informasi Pemilik</h6>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <p><strong>Nama:</strong> <?= htmlspecialchars($pesan['nama_pemilik']) ?></p>
                                            <p><strong>Telepon:</strong> <?= $pesan['telepon_pemilik'] ?></p>
                                        </div>
                                        <div class="col-md-6">
                                            <p><strong>Email:</strong> <?= $pesan['email_pemilik'] ?? '-' ?></p>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="detail-section">
                                        ...
                                        <?php if ($pesan['alasan_penolakan']): ?>
                                            <div class="alert alert-danger mt-3">
                                                <h6 class="fw-bold"><i class="fas fa-times-circle me-2"></i>Alasan Penolakan Pembayaran</h6>
                                ...
                                <?php if ($pesan['catatan_pembatalan']): ?>
                                    <div class="detail-section">
                                        <div class="alert alert-warning">
                                            <h6 class="fw-bold"><i class="fas fa-info-circle me-2"></i>Alasan Pembatalan</h6>
