...
// Query pemesanan - SESUAIKAN DENGAN STRUCTURE DATABASE YANG ADA
...
if ($status_filter !== 'all') {
    $stmt->bind_param("is", $pencari_id, $status_filter);
} else {
    $stmt->bind_param("i", $pencari_id);
}
...
$stmt_stats->bind_param("i", $pencari_id);
$stmt_stats->execute();
