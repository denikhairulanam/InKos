...
$nama_user = $_SESSION['user_nama'] ?? $_SESSION['nama'] ?? 'Pencari'; // PERBAIKAN: Handle multiple session keys
...
// Jika tidak ada data, set default values
if (!$stats) {
    $stats = [
        'total_pemesanan' => 0,
        'menunggu' => 0,
...
$stmt_pemesanan->bind_param("i", $pencari_id);
$stmt_pemesanan->execute();
$result_pemesanan = $stmt_pemesanan->get_result();
$pemesanan_terbaru = $result_pemesanan->fetch_all(MYSQLI_ASSOC);

// Ambil rekomendasi kos berdasarkan daerah yang sering dicari
...
$rekomendasi_kos = $result_rekomendasi->fetch_all(MYSQLI_ASSOC);
?>
            ...
            <div class="col-lg-6 mb-4">
                <div class="card">
                    <div class="card-header bg-white d-flex justify-content-between align-items-center">
                        ...
                        <a href="cari_kos.php" class="btn btn-sm btn-outline-primary">Lihat Semua</a>
                    </div>
                    <div class="card-body">
                        <div class="row">
